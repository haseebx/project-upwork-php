                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-cogs fa-fw"></i> What's New</h3>
                        </div>
                        <div class="panel-body">
                            <div id="morris-area-chart">
                                <div class="row">
									...
									<div class="panel-body">
                                    <div id="morris-area-chart">
                                    <form action="act-process/all-new-action.php" id="catsfrm" name="catsfrm" method="post" onSubmit="return chkfrmAct();">
                                    <table>
                                    	<thead>
                                        	<tr>
                                            	<th>
									...
									<?php 
                                    $QRY = qry_run("select * from ms_prods where pshow = 'Yes' AND new = 'Yes' order by feature_ranking"); 
                                    if (num_rec($QRY) > 0) 
                                    { 
                                    $p = 1; 
