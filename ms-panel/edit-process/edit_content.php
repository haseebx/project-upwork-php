                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div id="morris-area-chart">
                                <div class="row">
										<?php
                                        $QRY = qry_run("select * from ms_contents WHERE mainid = ".ch_lvl('mid')."");
                                        if (num_rec($QRY) > 0)
                                        {
                                        $rs = fetch_rec($QRY);
                                        
                                        ?>
                                        <form action="<?=$web_url?>/process/content_process.php" method="post" enctype="multipart/form-data" name="frm_add" onSubmit="javascript:return chk_form();">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="plink" placeholder="Page Slug" value="<?=$rs['plink']?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <p class="help-block">Please Insert Your Page Image.</p>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                        	<div class="form-group">
                                            	<img src="<?=$web_url_1?>items/pages/<?=$rs['img1']?>" class="img-responsive" />
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <ol class="breadcrumb">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                            	<button type="submit" class="btn btn-primary">Update</button> <a href="<?=$web_url?>/content.php" class="btn btn-danger">Cancel</a>
                                            </div>
                                        </div>
                                    </form>
                                    <?php
