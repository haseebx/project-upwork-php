                        ...
                        <div class="panel-body">
                            <div id="morris-area-chart">
                                <div class="row">
                                        ...
                                        <?php 
                                        $QRY = qry_run("select * from ms_section WHERE mainid = ".ch_lvl('mid')." AND secid = ".ch_lvl('sec').""); 
                                        if (num_rec($QRY) > 0) 
                                        { 
                                        $rs = fetch_rec($QRY); 
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                            	<button type="submit" class="btn btn-primary">Update</button> <a href="<?=$web_url?>/secions.php?mid=<?=$_REQUEST['mid']?>" class="btn btn-danger">Cancel</a>
                                            </div>
                                        </div>
                                        <?php }?>
                                    </form>
